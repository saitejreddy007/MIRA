    ...
    <Card className="p-6 sm:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1.5">
          Pick up where your AI left off.
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <a
              href="#"
              className="text-xs font-medium text-primary hover:text-primary/80 transition-colors duration-500 ease-spring"
            >
              Forgot?
            </a>
          </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className={cn('btn-primary w-full h-11 text-sm group')}
        >
          {loading ? (
            <>
      ...
      <Link
        href="/signup"
        className="btn-secondary w-full h-11 text-sm justify-center"
      >
        Create an account
      </Link>
    </Card>
